...
namespace MusicEco.Views.Sections.Playlist;

public partial class PlaylistDetailSlot : ContentView
{
    #region Base
    ...
    public PlaylistDetailSlot()
	{
		InitializeComponent();
	}
    private const string SlotKind = "PlaylistDetail";
    #endregion
    #region Slot
    ...
    private void RemoveOption_Clicked(object sender, TappedEventArgs e) {
    ...
    private void DialogButton_ConfirmClicked(object sender, EventArgs e) {
        ...
        ViewModel.DeleteFromCurrentSelectedPlaylist();
    }
    #endregion
    #region FormMenu
