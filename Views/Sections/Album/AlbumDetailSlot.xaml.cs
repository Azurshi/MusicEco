...
public partial class AlbumDetailSlot : ContentView
{
    #region Base
    ...
    public AlbumDetailSlot()
	{
		InitializeComponent();
	}
    private const string SlotKind = "Album";
    #endregion
    #region Slot
    private void OnTitleClicked(object sender, TappedEventArgs e) {
    ...
    private void OnOptionClicked(object sender, TappedEventArgs e) {
        ...
        DataTemplate template = (DataTemplate)this.Resources[$"{SlotKind}DetailOptionTemplate"];
