...
namespace MusicEco.Views.Sections.Explorer;

public partial class ExplorerSlot : ContentView
{
    #region Base
    ...
    private ViewModels.Slots.ExplorerSlot ViewModel => (ViewModels.Slots.ExplorerSlot)this.BindingContext;
    public ExplorerSlot()
	{
		InitializeComponent();
	}
    private const string SlotKind = "Explorer";
    #endregion
    #region Slot
    private void Title_Clicked(object sender, TappedEventArgs e) {
        var slotData = ViewUtil.ChaseParent<ViewModels.Slots.ExplorerSlot>(sender, out DataList dataList);
