...
public partial class QueueDetailSlot : ContentView
{
    #region Base
    ...
    public QueueDetailSlot()
	{
		InitializeComponent();
	}
    private const string SlotKind = "QueueDetail";
    #endregion
    #region Slot
    ...
    private void DialogButton_ConfirmClicked(object sender, EventArgs e) {
        ...
        ViewModel.DeleteFromCurrentSelectedQueue();
    }
    #endregion
    #region FormMenu
