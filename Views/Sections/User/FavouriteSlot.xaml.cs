...
namespace MusicEco.Views.Sections.User;

public partial class FavouriteSlot : ContentView {
    #region Base
    ...
    private ViewModels.Slots.AdditionSongSlot ViewModel => (ViewModels.Slots.AdditionSongSlot)this.BindingContext;
    public FavouriteSlot() {
        InitializeComponent();
    }
    private const string SlotKind = "Favourite";
    #endregion
    #region Slot
    private void Title_Clicked(object sender, TappedEventArgs e) {
        var slotData = ViewUtil.ChaseParent<ViewModels.Slots.AdditionSongSlot>(sender, out DataList dataList);
